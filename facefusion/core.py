...
def cli() -> None:
	...
	print(wording.get('help.execution_providers'))
	print(wording.get('help.execution_providers').format(choices = ', '.join(execution_providers)))
	print(config.get_str_list('execution.execution_providers', 'cpu'))
	print(facefusion.choices.execution_thread_count_range)
	...
	print("list_directory",available_frame_processors)
...
def apply_args(program : ArgumentParser) -> None:
	...
	print("args.face_detector_size",args.face_detector_size)
	print("facefusion.choices.face_detector_set[args.face_detector_model]",facefusion.choices.face_detector_set[args.face_detector_model])
	...
	if is_video(args.target_path):
		...
		if args.output_video_resolution in output_video_resolutions:
			...
			print("facefusion.globals.output_video_resolution =",facefusion.globals.output_video_resolution)
	print("args.output_video_fps",args.output_video_fps)
	...
	# frame processors
	available_frame_processors = list_directory('facefusion/processors/frame/modules')
	print("available_frame_processors",available_frame_processors)
	...
	print("args.ui_layouts",args.ui_layouts)
